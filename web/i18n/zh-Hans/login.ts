...
const translation = {
  pageTitle: '嗨，近来可好',
  welcome: `👋 欢迎来到 ${brandConfig.name}, 登录以继续`,
  email: '邮箱',
  ...
  license: {
    tip: `启动 ${brandConfig.name} 社区版之前, 请阅读 GitHub 上的`,
    link: '开源协议',
  },
  join: '加入 ',
  joinTipStart: '邀请你加入 ',
  ...
  licenseExpiredTip: `您所在空间的 ${brandConfig.name} Enterprise 许可证已过期，请联系管理员以继续使用 ${brandConfig.name}。`,
  licenseLost: '许可证丢失',
  licenseLostTip: `无法连接 ${brandConfig.name} 许可证服务器，请联系管理员以继续使用 ${brandConfig.name}。`,
  licenseInactive: '许可证未激活',
  licenseInactiveTip: `您所在空间的 ${brandConfig.name} Enterprise 许可证尚未激活，请联系管理员以继续使用 ${brandConfig.name}。`,
}
